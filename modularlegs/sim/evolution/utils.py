...
def gen_log_dir(design_pipeline):
    ...
    """
    design_pipeline = np.reshape(design_pipeline, (-1, 4))
    asset_dir = os.path.join(LEG_ROOT_DIR, "modularlegs", "sim", "assets", "robots", "factory")
...
def gen_log_dir_asym(design_pipeline):
    ...
    """
    asset_dir = os.path.join(LEG_ROOT_DIR, "modularlegs", "sim", "assets", "robots", "factory", "asym")
