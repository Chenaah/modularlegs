...
from modularlegs.sim.evolution.encoding_wrapper import decode_onehot, extent_to_5x1, polish, polish_4x, polish_asym
from modularlegs.sim.evolution.vae import utils
# from cilia2d import CILIA2D_ROOT_DIR
# from cilia2d.util import create_log_dir, get_freer_gpu
from modularlegs.sim.evolution.vae.linear_vae import LinearVAE
from modularlegs.sim.evolution.vae.abo import AsynchronousBO
from modularlegs.sim.evolution.vae.weighted_dataset import WeightedDataset
from modularlegs.utils.logger import LoggerCallback
from modularlegs.utils.others import get_freer_gpu

class DebugCallback(pl.Callback):


    def on_validation_epoch_end(self, trainer, pl_module):
        from modularlegs.sim.evolution.test.inverse_vae import TRIPOD_DP, TRIPOD_ONEHOT
...
def get_vae_cfg():
    ...
    vae_cfg = {
        ...
        "dataset_path": os.path.join(LEG_ROOT_DIR, "modularlegs/sim/evolution/vae/designs_short.pkl"),
