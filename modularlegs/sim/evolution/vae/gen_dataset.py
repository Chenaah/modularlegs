...
# from modularlegs.sim.evolution.mutation_meta import random_gen
# from modularlegs.sim.evolution.async_ga_meta import are_ok
from rich.progress import Progress

# from modularlegs.sim.evolution.utils import is_metapipeline_valid
import concurrent.futures

from modularlegs.sim.designer_utils import fast_self_collision_check
from modularlegs.sim.robot_metadesigner import MetaDesignerAsym
from modularlegs.sim.scripts.homemade_robots_asym import MESH_DICT_DRAFT_CYLINDER, ROBOT_CFG_AIR1S
...
def gen_dateset(min_n_modules=2, max_n_modules=6, data_name="designs", ave_speed_threshold=0.15):
    ...
    design_file = os.path.join(LEG_ROOT_DIR, f"modularlegs/sim/evolution/vae/{data_name}.pkl")
...
if __name__ == "__main__":
    ...
    # test_gen_asym4x()
    # fix_tuple(os.path.join(LEG_ROOT_DIR, f"modularlegs/sim/evolution/vae/designs_short.pkl"))
