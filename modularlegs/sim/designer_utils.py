...
from modularlegs.utils.model import XMLCompiler, get_joint_pos_addr, quaternion_from_vectors
...
def fast_self_collision_check(pipeline):
    ...
    '''
    from modularlegs.sim.scripts.homemade_robots_asym import MESH_DICT_DRAFT_CYLINDER, ROBOT_CFG_AIR
