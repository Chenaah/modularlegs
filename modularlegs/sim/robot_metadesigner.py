...
from modularlegs.sim.robot_designer import DEFAULT_ROBOT_CONFIG, Connect, ConnectAsym, RobotDesigner, calculate_transformation_matrix, matrix_to_pos_quat, numpy_to_native
from modularlegs.utils.math import construct_quaternion, quaternion_multiply2
...
def test_local_rew():
    from modularlegs.sim.evolution.encoding_wrapper import polish
