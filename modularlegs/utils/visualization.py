...
from modularlegs.utils.math import quat_rotate, quat_rotate_inverse, quaternion_to_euler, quaternion_to_euler2, wxyz_to_xyzw
from modularlegs.utils.model import XMLCompiler, compile_xml, get_joint_pos_addr
...
def take_photo(conf=None, 
               ...
               shadow=True,
               alphas=None):
    from modularlegs.sim.evolution.utils import update_cfg_with_pipeline
...
def rollout(conf_name, model_file, save_file=None, callback=None, take_video=False, file_name=None):
    ...
    from modularlegs.scripts.train_sbx import load_model
    from modularlegs.envs.env_sim import ZeroSim
